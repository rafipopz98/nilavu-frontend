...
import { APPLIED_JOBS_STATUS_TYPE } from "../../lib/constants";
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-5">
        <div className="flex flex-col gap-4">
          <Dropdown
            ...
            label="Status"
            options={APPLIED_JOBS_STATUS_TYPE}
            onChange={(val) => handleChange(val, "applied_status")}
          />
        </div>
      </div>
