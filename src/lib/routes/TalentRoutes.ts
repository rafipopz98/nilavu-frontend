export const TALENT_MAIN_ROUTE = "/talent";

export const TALENT_ROUTES = {
  DASHBOARD: `${TALENT_MAIN_ROUTE}/dashboard`,
  FIND_JOBS: `${TALENT_MAIN_ROUTE}/find-jobs`,
  APPLIED_JOBS: `${TALENT_MAIN_ROUTE}/applied-jobs`,
